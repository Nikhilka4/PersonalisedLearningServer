...
exports.registerationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const html = await ejs_1.default.renderFile(path_1.default.join(__dirname, "../mails/activation-mails.ejs"), data);
        try {
...
exports.updateAccessToken = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        res.cookie("refresh_token", refreshToken, jwt_2.refreshTokenOptions);
